# Archived experiment: PrivAiTe 0.4.2 source

**Historical report.** For the released package and current setup, use the
[0.4.3 experiment](OPENCODE-EXPERIMENT.md). The hashes below identify the old
measurements; they are not installation instructions.
...
the [README](SETUP.md#put-privaite-before-the-capture-point). Start the proxy
